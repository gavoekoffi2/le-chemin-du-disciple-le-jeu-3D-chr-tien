...
GAME.DATA.npcs = {
  ...
  tabitha:   { name: 'Tabitha la couturière', portrait: '🧵', pos: [-94, 8], color: 0x9a4a7a,
    idle: "Bienvenue chez Tabitha ! Je couds des tuniques et des vêtements pour toute la ville. (Actes 9:39)" },
